...
const MeetDetail: NextPage<MeetDetailProps> = ({
  ...
  const meetUpDetail = useDetailPage<MeetUpSWRResponse>(
  ...
  switch (meetUpDetail.status) {
    case "ok":
      const { meetUp, isLiked, isJoined } = meetUpDetail.data;
      return (
