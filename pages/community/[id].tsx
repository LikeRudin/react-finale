...
const CommunityPostDetail: NextPage = () => {
  return (
    <Layout title="의정부 족발 맛집" seoTitle="의정부 족발 맛집" hasBack>
      <div className="h-full">
        <div>
          <div className="profile flex items-center px-4 cursor-pointer py-4 space-x-4 border-t border-b">
            ...
            <div className="flex-col space-y-1">
              <p className="text-sm font-medium text-gray-300">니콜라스</p>
        ...
        <div className="mb-2">
          <div className="cursor-pointer flex flex-col items-start py-5">
            <span className="flex ml-4 items:center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-300">
              잡담
            </span>
            <div className="mt-2 px-4 text-gray-300">
              <span className="text-orange-700 font-medium">Q.</span> 의정부
              족발 맛집 어디없나요?
            </div>
            <div className="mt-5 px-4 w-full flex items-center justify-between text-gray-200 font-medium text-xs">
              <span>18시간 전</span>
            </div>
            <div className="meta-info border-b-[2px] w-full flex px-4 py-5 space-x-5 mt-3 text-gray-300">
